...
import { RiHome, RiHomeFill } from 'react-icons/ri'
    ...
    return (
        <div className="flex flex-col justify-between bg-white h-full overflow-y-scrikk min-w-210 hide-scrollbar">
            <div className="flex flex-col">
                <Link
                    to="/"
                    className="flex px-5 my-4 pt-1 w-200 item-center"
                    onClick={handleCloseSidebar}
                >
                    <img src={logo} alt="logo" className="w-16" />
                    <p className="font-pacifico" style={{ display: 'inline-block', fontSize: 30}}>
                        Pixibit 
                    </p>
                </Link>
                <div className="flex flex-col gap-5">
                    ...
                    <h3 className="mt-2 px-5 text-base 2xltext-xl">Discover Categories</h3>
